...
namespace IdentityScoreJult28.Controllers
{
    ...
    public class OptionsDTOController : Controller
    {
        ...
        public OptionsDTOController (IUnitOfWork unitOfWork, ILogger<OptionsDTOController> logger)
            {
        ...
        // GET: api/SurveyName
        [HttpGet, Route("GetSurveyOptions/{SurveyName}")]
        public IActionResult GetSurveyOptions(string SurveyName)
        {
            ...
            if (Survey != null)
            {
                ...
                surveyOpt.redirectingUrl = Survey.RedirectingUrl;
       ...
       // [ValidateAntiForgeryToken]
        ...
        public async Task<ActionResult> CreateSurvey([FromBody]SurveyOptionsViewModel soptions)
        {
            ...
            try
            {
                ...
                CalSurvey.RedirectingUrl = soptions.RedirectingUrl;
        ...
        public async Task<ActionResult> UpdateSurvey(int id, [FromBody]SurveyOptionsViewModel soptions)
        {
            ...
            try
            {
                ...
                surveyobj.RedirectingUrl = soptions.RedirectingUrl;
