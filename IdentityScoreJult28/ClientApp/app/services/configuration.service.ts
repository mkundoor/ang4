...
export class ConfigurationService {
   ...
   // public baseUrl: string = Utilities.baseUrl().replace(/\/$/, '');
    public baseUrl: string = "http://appsdev.nursing.upenn.edu/pstar";
   // public baseUrl: string = "http://apps.nursing.upenn.edu/pstar";
    public fallbackBaseUrl: string = "http://appsdev.nursing.upenn.edu/pstar";
