...
export class AccountEndpoint extends EndpointFactory {
    ...
    getNewUserEndpoint(userObject: any): Observable<Response> {
        ...
        return this.http.post(this.usersUrl, JSON.stringify(userObject), this.getAuthHeader(true))
            .map((response: Response) => {
                console.log("Inside the End point User");
                return response;
            })
            .catch(error => {
...
//-----------------------------------------------------------------------------------------------------------------------------
    registerNewUserEndpoint(userObject: any): Observable<Response> {
        let endpointurl = this.usersUrl;
        console.log("the url of the controller",endpointurl);
        let body = JSON.stringify(userObject);
        let headers = new Headers({ 'content-type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
        console.log("inside registering end point service ");
       // console.log(body);
