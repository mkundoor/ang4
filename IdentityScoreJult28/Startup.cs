// ======================================
// Author: https://cpratt.co/using-automapper-creating-mappings/
// ======================================
...
using IdentityScoreJult28.Policies;
...
namespace IdentityScoreJult28
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["Data:DefaultConnection:ConnectionString"], b => b.MigrationsAssembly("IdentityScoreJult28"));
